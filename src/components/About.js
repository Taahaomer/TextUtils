...
export default function About (props) {
    ...
    const toggle = () => {
        if (modeChange.backgroundColor === "white") {
            setModeChange({ backgroundColor: "black", color: "white" });
            setText("Enable light mode")
        } else {
            setModeChange({ backgroundColor: "white", color: "black" });
    ...
    return (
        <>
            ...
            <div className="my-2">
                <button type="button" onClick={toggle} className={`btn btn-${props.mode} my-2 mx-1`}>{Text}</button>
            </div>
